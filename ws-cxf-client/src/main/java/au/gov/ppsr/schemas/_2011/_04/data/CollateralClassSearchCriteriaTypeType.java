...
/**
 * <p>Java class for CollateralClassSearchCriteriaType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CollateralClassSearchCriteriaType">
 ...
 * 
 */
@XmlType(name = "CollateralClassSearchCriteriaType")
@XmlEnum
public enum CollateralClassSearchCriteriaTypeType {
    ...
    CollateralClassSearchCriteriaTypeType(String v) {
        value = v;
    }
    ...
    public static CollateralClassSearchCriteriaTypeType fromValue(String v) {
        for (CollateralClassSearchCriteriaTypeType c: CollateralClassSearchCriteriaTypeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
