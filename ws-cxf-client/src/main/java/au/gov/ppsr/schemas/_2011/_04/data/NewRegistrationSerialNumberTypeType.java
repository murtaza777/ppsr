...
/**
 * <p>Java class for NewRegistrationSerialNumberType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="NewRegistrationSerialNumberType">
 ...
 * 
 */
@XmlType(name = "NewRegistrationSerialNumberType")
@XmlEnum
public enum NewRegistrationSerialNumberTypeType {
    ...
    NewRegistrationSerialNumberTypeType(String v) {
        value = v;
    }
    ...
    public static NewRegistrationSerialNumberTypeType fromValue(String v) {
        for (NewRegistrationSerialNumberTypeType c: NewRegistrationSerialNumberTypeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
