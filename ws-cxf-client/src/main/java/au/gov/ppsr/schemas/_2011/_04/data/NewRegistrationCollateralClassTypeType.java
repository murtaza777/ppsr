...
/**
 * <p>Java class for NewRegistrationCollateralClassType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="NewRegistrationCollateralClassType">
 ...
 * 
 */
@XmlType(name = "NewRegistrationCollateralClassType")
@XmlEnum
public enum NewRegistrationCollateralClassTypeType {
    ...
    NewRegistrationCollateralClassTypeType(String v) {
        value = v;
    }
    ...
    public static NewRegistrationCollateralClassTypeType fromValue(String v) {
        for (NewRegistrationCollateralClassTypeType c: NewRegistrationCollateralClassTypeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
